...
int main() {
  ...
  // using cin to input a string only inputs the characters till a whitespace in
  // the string Eg: Input - Strings are fun! String stored: Strings To avoid
  // this we can use the getline() function
  while (getchar() != '\n')
    ; // This line is just to remove the '\n' character from the buffer
      // otherwise the next input will be skipped
