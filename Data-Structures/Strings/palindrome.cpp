/*
 * A given string is said to be a palindrome if on reversing it we obtain the
 * same string Eg: aabbaa <-> aabbaa; racecar <-> racecar
 */
...
bool isPalindrome(string s) {
  for (int i = 0; i < s.length() / 2;
       i++) { // iterate the string from both ends towards the center and check
