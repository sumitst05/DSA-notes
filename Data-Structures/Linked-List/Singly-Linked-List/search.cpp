...
// This function searches for a node in a linked list that contains a given value
void search(Node *head, int x) {
    // Create a pointer called "n" and initialize it to point to the same location in memory as "head"
    Node *n = head;
    ...
    // If we've reached the end of the linked list without finding the node, print a message indicating that it wasn't found
