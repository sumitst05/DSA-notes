...
int main() {
    ...
    /* Note: emplace_front and emplace_back construct the new element(s) directly in the deque's memory space, 
     * while push_front and push_back add already constructed elements to the deque by copying or moving them. 
     * This can result in more efficient code as the objects can be constructed directly in the memory space of the container, 
     * without the need for temporary objects or additional copies/moves.
     */
