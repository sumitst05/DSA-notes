...
int main() {
    ...
    /* 
     * Note: emplace is similar to push, but it constructs the new element in place, 
     * using its arguments to initialize the element. 
     * This can be more efficient than creating the element separately and then passing it to push.
     */
